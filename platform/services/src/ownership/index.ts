/**
 * Ownership Services - Application Layer Export
 *
...
/**
 * Ownership Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for ownership domain.
 */
