/**
 * Partners Services - Application Layer Export
 *
...
/**
 * Partners Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for partners domain.
 */
