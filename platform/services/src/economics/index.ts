/**
 * Economics Services - Application Layer Export
 *
...
/**
 * Economics Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for economics domain.
 */
