/**
 * Conflicts Services - Application Layer Export
 *
...
/**
 * Conflicts Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for conflicts domain.
 */
