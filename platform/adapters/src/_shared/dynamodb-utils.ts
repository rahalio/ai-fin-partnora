 ...
 *
 * @returns The core table name (e.g., "partnora-core-dev")
 ...
 *
 * @returns The base table name (e.g., "partnora-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "partnora-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "partnora-app-realtime-dev")
